      ...
      <div className="pt-16">
        ...
        <div className="bg-white border-b border-border py-14 px-6">
          <div className="max-w-6xl mx-auto">
            <p className="text-xs tracking-[0.3em] uppercase text-primary mb-2">O Artista</p>
            <h1 className="font-serif text-4xl md:text-5xl text-foreground">Sobre O Abstrato Doido</h1>
          </div>
        </div>
        ...
        <section className="py-20 bg-[hsl(40,43%,96%)]">
          <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
            ...
            <div className="pt-4">
              <p className="text-5xl font-serif text-primary leading-none mb-6">"</p>
              <p className="font-serif text-2xl md:text-3xl text-foreground leading-snug mb-8">
                Bem-vindo ao meu espaço de expressão. Crio para transcender barreiras.
              </p>
        ...
        <section className="py-20 bg-white">
          <div className="max-w-3xl mx-auto px-6">
            <h2 className="font-serif text-3xl text-primary mb-6">A Minha História</h2>
        ...
        <section className="py-20 bg-[hsl(40,43%,96%)]">
          <div className="max-w-3xl mx-auto px-6">
            <h2 className="font-serif text-3xl text-foreground mb-6">O Processo Criativo</h2>
            <p className="text-muted-foreground leading-relaxed mb-4">
              Começar a pintar é uma jornada onde cada pincelada pode mudar tudo. Não trabalho com esboços — o processo é intuitivo, guiado pela emoção do momento e pela energia do espaço.
            </p>
            <p className="text-muted-foreground leading-relaxed mb-4">
              Uso tintas acrílicas e óleo, espátulas e os próprios dedos. O corpo todo participa na criação. Cada obra nasce de uma série de camadas, cada uma com a sua história, invisível mas presente.
            </p>
            <p className="text-muted-foreground leading-relaxed">
              O caos é parte do método. Acredito que a obra perfeita é a que surpreende o próprio artista.
            </p>
          </div>
        </section>
        ...
        <section className="py-20 bg-white">
          <div className="max-w-6xl mx-auto px-6">
            <h2 className="font-serif text-3xl text-foreground mb-12 text-center">A Filosofia das Cores</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="flex gap-6 items-start">
                <div className="w-16 h-16 flex-shrink-0 bg-orange-500 flex items-center justify-center">
                  <span className="text-white font-serif text-xs text-center leading-tight px-1">Laranja</span>
                </div>
                <div>
              ...
              <div className="flex gap-6 items-start">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm leading-relaxed">
                    O azul profundo é a meditação. É o espaço entre os sons, o instante antes do gesto. Nas minhas obras, o azul convida ao mergulho interior.
                  </p>
                </div>
              </div>
              <div className="flex gap-6 items-start">
                <div className="w-16 h-16 flex-shrink-0 bg-yellow-600 flex items-center justify-center">
                  <span className="text-white font-serif text-xs text-center leading-tight px-1">Dourado</span>
                </div>
                <div>
                  <h3 className="font-serif text-xl text-yellow-700 mb-2">Dourado — Transcendência</h3>
                  <p className="text-muted-foreground text-sm leading-relaxed">
                    O dourado é raro nas minhas telas — e por isso, quando aparece, é sagrado. É a luz que atravessa, o momento de graça que a arte pode capturar.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="py-20 bg-[hsl(40,43%,96%)]">
          <div className="max-w-6xl mx-auto px-6">
            <h2 className="font-serif text-3xl text-foreground mb-10 text-center">Bastidores do Atelier</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
              <img src={artistPng} alt="Atelier 1" className="w-full aspect-square object-cover" />
              <img src={artistPng} alt="Atelier 2" className="w-full aspect-square object-cover md:translate-y-8" />
              <img src={artistPng} alt="Atelier 3" className="w-full aspect-square object-cover" />
            </div>
          </div>
        </section>
      </div>
